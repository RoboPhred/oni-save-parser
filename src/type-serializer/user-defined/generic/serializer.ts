...
import {
    UserDefinedGenericTypeDescriptor
} from "./descriptor";


@injectable(TypeSerializationInfo)
export class UserDefinedGenericTypeSerializer implements TypeSerializationInfo<object | null, UserDefinedGenericTypeDescriptor<object>> {
