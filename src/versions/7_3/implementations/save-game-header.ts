...
import { injectable, inScope } from "microinject";

import { ensureNotNull } from "../../../utils";

import { DataReader, DataWriter } from "../../../binary-serializer";

import { SaveGameHeaderInstance, SaveGameScope } from "../services";
...
export class SaveGameHeaderInstanceImpl implements SaveGameHeaderInstance {
  ...
  parse(reader: DataReader) {
    ...
    this._isCompressed =
      this._headerVersion >= 1 ? Boolean(reader.readUInt32()) : false;
