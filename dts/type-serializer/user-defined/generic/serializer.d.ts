...
import { TypeSerializationInfo, TypeTemplateSerializer, TypeDescriptorSerializer, TypeTemplateRegistry } from "../../services";
...
export declare class UserDefinedGenericTypeSerializer implements TypeSerializationInfo<object | null, UserDefinedGenericTypeDescriptor<object>> {
    ...
    constructor(_templateRegistry: TypeTemplateRegistry, _descriptorSerializer: TypeDescriptorSerializer, _templateSerializer: TypeTemplateSerializer);
