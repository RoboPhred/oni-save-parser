...
__decorate([
    microinject_1.inject(services_1.TypeSerializer)
], TypeTemplateRegistryImpl.prototype, "_typeSerializer", void 0);
TypeTemplateRegistryImpl = __decorate([
    microinject_1.injectable(),
    microinject_1.provides(services_1.TypeTemplateRegistry),
    microinject_1.provides(services_1.TypeTemplateSerializer),
