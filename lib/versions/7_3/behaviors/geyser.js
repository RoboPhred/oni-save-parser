...
exports.GEYSER_TYPE_NAMES = Object.keys(exports.GEYSER_TYPE_HASHES);
exports.GEYSER_TYPE_HASH_NAMES = {};
for (let geyserType of exports.GEYSER_TYPE_NAMES) {
    const hash = helpers_1.getSDBMHash32(geyserType);
    exports.GEYSER_TYPE_HASHES[geyserType] = hash;
...
function getGeyserTypeHash(name) {
    if (!Object.prototype.hasOwnProperty.call(exports.GEYSER_TYPE_HASHES, name)) {
        return undefined;
    }
    return exports.GEYSER_TYPE_HASHES[name];
}
