...
exports.ACCESSORY_TYPES = ["eyes", "hair", "headshape", "mouth", "body"];
exports.AccessorizerBehavior = "Accessorizer";
;
exports.ACCESSORIZER_EYE_GUIDS = [
    1,
    2,
    3,
    4,
...
exports.ACCESSORIZER_HEAD_GUIDS = [
    1,
    2,
    3,
    4
].map(x => makeAccessoryID("headshape", x));
exports.ACCESSORIZER_MOUTH_GUIDS = [
    1,
    2,
    3,
    4
...
exports.ACCESSORIZER_BODY_GUIDS = [
    1,
    2,
    3,
    4
