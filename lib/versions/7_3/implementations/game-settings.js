...
let GameSettingsInstanceImpl = class GameSettingsInstanceImpl {
    ...
    get baseAlreadyCreated() {
        return utils_1.ensureNotNull(this._data, "The value has not yet been parsed.").baseAlreadyCreated;
    }
    get nextUniqueID() {
        return utils_1.ensureNotNull(this._data, "The value has not yet been parsed.").nextUniqueID;
    }
    get gameID() {
        return utils_1.ensureNotNull(this._data, "The value has not yet been parsed.").gameID;
    }
    parse(reader) {
