...
let UserDefinedGenericTypeSerializer = class UserDefinedGenericTypeSerializer {
    constructor(_templateRegistry, _descriptorSerializer, _templateSerializer) {
...
UserDefinedGenericTypeSerializer = __decorate([
    ...
    __param(0, microinject_1.inject(services_2.TypeTemplateRegistry)),
    __param(1, microinject_1.inject(services_2.TypeDescriptorSerializer)),
    __param(2, microinject_1.inject(services_2.TypeTemplateSerializer))
