...
__decorate([
    microinject_1.inject(services_2.TypeSerializationInfo, { all: true })
], TypeSerializerImpl.prototype, "_serializerInfos", void 0);
__decorate([
    microinject_1.inject(services_2.TypeTemplateRegistry)
], TypeSerializerImpl.prototype, "_templateRegistry", void 0);
TypeSerializerImpl = __decorate([
    microinject_1.injectable(),
    microinject_1.provides(services_2.TypeSerializer),
    microinject_1.provides(services_2.TypeDescriptorSerializer),
