...
let OniSaveRootImpl = class OniSaveRootImpl {
    ...
    parse(reader) {
        ...
        this._saveFileRoot = this._typeSerializer.parseTemplatedType(reader, exports.SaveFileRoot);
    }
    write(writer) {
        ...
        this._typeSerializer.writeTemplatedType(writer, exports.SaveFileRoot, this._saveFileRoot);
    }
    toJSON() {
        const streamed = {};
