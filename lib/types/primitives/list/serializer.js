...
let ListTypeSerializer = class ListTypeSerializer {
    constructor(_typeSerializer) {
        this._typeSerializer = _typeSerializer;
        this.id = interfaces_1.TypeInfo.List;
        this.name = "list";
    }
...
exports.ListTypeSerializer = ListTypeSerializer;
;
